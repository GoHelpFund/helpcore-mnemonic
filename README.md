...
This module is superceded the functionality in @gohelpfund/helpcore-lib, please use that package moving forward.

[![Build Status](https://img.shields.io/travis/gohelpfund/helpcore-mnemonic/master.svg)](https://travis-ci.org/gohelpfund/helpcore-mnemonic)
[![NPM Package](https://img.shields.io/npm/v/@gohelpfund/helpcore-mnemonic.svg)](https://www.npmjs.org/package/@gohelpfund/helpcore-mnemonic)

> BIP39 Mnemonics for Helpcore

A module for [helpcore-lib](https://github.com/gohelpfund/helpcore-lib) that implements [Mnemonic code for generating deterministic keys](https://github.com/bitcoin/bips/blob/master/bip-0039.mediawiki).

## Install

```sh
npm install @gohelpfund/helpcore-mnemonic
```
...
This will generate a file `dist/helpcore-mnemonic.js`, which can be included into your HTML a-like so:

```html
<html lang="en">
<head>
  <title>Tester - HelpCore Mnemonic</title>
  <script language="javascript" src="dist/helpcore-mnemonic.js"></script>
</head>
<body>
  <script>
    document.addEventListener("DOMContentLoaded", function() {
      var mnemonic = new helpcoreMnemonic();
...
Feel free to dive in! [Open an issue](https://github.com/gohelpfund/helpcore-mnemonic/issues/new) or submit PRs.
...
Copyright 2015-2018 Help Core Group, Inc.
